...
void LoRaClass::onReceive(void(*callback)(int))									//callback wird im handleDI0Rise aufgerufen!!
{																				//TODO: wenn transaktion gestartet wird Interrupt beenden!!! danach wieder starten
	_onReceive = callback;
